...
app->log->level('fatal'); # TODO: this is needed because we just stack a new set of hooks onto the global acl every time we load the plugin. Realistically, reloading the plugin is not a big issue in the real world, but we should fix this someday
